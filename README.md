...
Message History: View previous chat messages
...
Adaptive Layout: Sidebar collapses on mobile, expands on desktop
...
User highlighting (current user marked as "You")
...
Input Sanitization: Prevents empty messages
...
│   │   └── UsersList.jsx     # Online users component
│   ├── App.jsx              # Root component with join screen
...
View Users: Click the hamburger menu (mobile) or see sidebar (desktop)
...
Close Sidebar: Tap outside sidebar or close button
...
<img width="1916" height="917" alt="image" src="https://github.com/user-attachments/assets/9de59949-b71c-431e-b3db-3af55de87263" />
